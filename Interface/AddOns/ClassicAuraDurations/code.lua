...
可能导致“脚本运行时间过长的错误”
    ...
    AddTooltip(lpd, "目标头像上,不是自己放的图标会更小.自己的则会更大, 降低OmniCC大小阈值可以仍在其上看到数字显示.")
    ebt.content = content
