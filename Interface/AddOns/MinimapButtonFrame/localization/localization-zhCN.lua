...
if (GetLocale() == "zhCN") then
	...
	MBF_TOOLTIP_FULL = "|cff1eff00左键:|r 隐藏/显示MBF\n|cff1eff00右键:|r 移动位置\n|cff1eff00Shift+左键:|r 打开设置";
	MBF_TOOLTIP_SMALL = "|cff1eff00Shift+左键:|r 打开设置";
	MBF_TOOLTIP_NO_MAIL = "没有新的邮件";
	MBF_TOOLTIP_ROLLUP = "|cff1eff00左键:|r 移动\n|cff1eff00右键:|r 隐藏";
