...
if (GetLocale() == "enUS") then
  MRBCAT = {
    ...
    ["Advanced Options|cffffff00*"]="ShaguTweaks|cffffff00*",
    ["Auto Dismount"] = "Auto Dismount",
    ["Automatically dismounts whenever a spell is casted."] = "Automatically dismounts whenever a spell is casted.",
    ["Auto Stance"] = "Auto Stance",
    ["Automatically switch to the required warrior or druid stance on spell cast."] = "Automatically switch to the required warrior or druid stance on spell cast.",
    ["Blue Shaman Class Colors"] = "Blue Shaman Class Colors",
    ["Changes the class color code of shamans to blue, as known from TBC+."] = "Changes the class color code of shamans to blue, as known from TBC+.",
    ["Chat Hyperlinks"] = "Chat Hyperlinks",
    ["Copy website URLs from the chat, transforms CLINKs into real items and handles quest links."] = "Copy website URLs from the chat, transforms CLINKs into real items and handles quest links.",
    ["Chat Tweaks"] = "Chat Tweaks",
    ["Allows to scroll using the mouse wheel, enables sticky chat channels and repeats message on arrow up."] = "Allows to scroll using the mouse wheel, enables sticky chat channels and repeats message on arrow up.",
    ["Cooldown Numbers"] = "Cooldown Numbers",
    ["Display  the remaining duration as text on every cooldown."] = "Display  the remaining duration as text on every cooldown.",
    ["Custom Settings"] = "Custom Settings",
    ["Custom code: Have a look at mods/custom.lua"] = "Custom code: Have a look at mods/custom.lua",
    ["Darkened UI"] = "Darkened UI",
    ["Turns the entire interface into darker colors."] = "Turns the entire interface into darker colors.",
    ["Equip Compare"] = "Equip Compare",
    ["Shows currently equipped items on tooltips while the shift key is pressed."] = "Shows currently equipped items on tooltips while the shift key is pressed.",
    ["Unit Frame Health Colors"] = "Unit Frame Health Colors",
    ["Change health text color based on its value."] = "Change health text color based on its value.",
    ["Real Health Numbers"] = "Real Health Numbers",
    ["Estimates health numbers, and shows numbers on player, pet and target unit frames."] = "Estimates health numbers, and shows numbers on player, pet and target unit frames.",
    ["Hide Errors"] = "Hide Errors",
    ["Hides and ignores all Lua errors produced by broken addons."] = "Hides and ignores all Lua errors produced by broken addons.",
    ["Hide Gryphons"] = "Hide Gryphons",
    ["Hides the gryphons left and right of the action bar."] = "Hides the gryphons left and right of the action bar.",
    ["Item Rarity Borders"] = "Item Rarity Borders",
    ["Show item rarity as the border color on bags, bank, character and inspect frames."] = "Show item rarity as the border color on bags, bank, character and inspect frames.",
    ["MiniMap Clock"] = "MiniMap Clock",
    ["Adds a small 24h clock to the mini map."] = "Adds a small 24h clock to the mini map.",
    ["MiniMap Square"] = "MiniMap Square",
    ["Draw the mini map in a squared shape instead of a round one."] = "Draw the mini map in a squared shape instead of a round one.",
    ["MiniMap Tweaks"] = "MiniMap Tweaks",
    ["Hides unnecessary mini map buttons and allows to zoom using the mouse wheel."] = "Hides unnecessary mini map buttons and allows to zoom using the mouse wheel.",
    ["Movable Unit Frames"] = "Movable Unit Frames",
    ["Player and Target unit frames can be moved while <Shift> and <Ctrl> are pressed together."] = "Player and Target unit frames can be moved while <Shift> and <Ctrl> are pressed together.",
    ["Nameplate Class Colors"] = "Nameplate Class Colors",
    ["Changes the nameplate health bar color to the class color."] = "Changes the nameplate health bar color to the class color.",
    ["Nameplate Scale"] = "Nameplate Scale",
    ["Makes all nameplates honor the UI-Scale setting."] = "Makes all nameplates honor the UI-Scale setting.",
    ["Reduced Actionbar Size"] = "Reduced Actionbar Size",
    ["Reduces the actionbar size by removing several items such as the bag panel and microbar"] = "Reduces the actionbar size by removing several items such as the bag panel and microbar",
    ["Sell Junk"] = "Sell Junk",
    ["Adds a “Sell Junk” button to every merchant window, that sells all grey items."] = "Adds a “Sell Junk” button to every merchant window, that sells all grey items.",
    ["Social Colors"] = "Social Colors",
    ["Show class colors in Who, Guild, Friends and Chat."] = "Show class colors in Who, Guild, Friends and Chat.",
    ["Enemy Castbars"] = "Enemy Castbars",
    ["Shows an enemy castbar on target unit frame."] = "Shows an enemy castbar on target unit frame.",
    ["Debuff Timer"] = "Debuff Timer",
    ["Show debuff durations on the target unit frame."] = "Show debuff durations on the target unit frame.",
    ["Tooltip Details"] = "Tooltip Details",
    ["Display health, class color, guild name, guild rank and current target on unit tooltips."] = "Display health, class color, guild name, guild rank and current target on unit tooltips.",
    ["Hide TWoW Target Health"] = "Hide TWoW Target Health",
    ["Hide Turtle-WoW Custom Health Points From Target Frame"] = "Hide Turtle-WoW Custom Health Points From Target Frame",
    ["Unit Frame Big Health"] = "Unit Frame Big Health",
    ["Increases the healthbar of the player and target unitframe."] = "Increases the healthbar of the player and target unitframe.",
    ["Unit Frame Class Colors"] = "Unit Frame Class Colors",
    ["Adds class colors to the player, target and party unit frames."] = "Adds class colors to the player, target and party unit frames.",
    ["Unit Frame Class Portraits"] = "Unit Frame Class Portraits",
    ["Replace unitframe portraits with class icons."] = "Replace unitframe portraits with class icons.",
    ["Vendor Values"] = "Vendor Values",
    ["Shows the vendor sell values on all item tooltips."] = "Shows the vendor sell values on all item tooltips.",
    ["WorldMap Class Colors"] = "WorldMap Class Colors",
    ["Show class colored circles on world and battlefield map."] = "Show class colored circles on world and battlefield map.",
    ["WorldMap Coordinates"] = "WorldMap Coordinates",
    ["Adds coordinates to the bottom of the World Map."] = "Adds coordinates to the bottom of the World Map.",
    ["WorldMap Window"] = "WorldMap Window",
    ["Turns the world map into a movable window. The map can be scaled with <Ctrl> + Mousewheel."] = "Turns the world map into a movable window. The map can be scaled with <Ctrl> + Mousewheel.",
    ["General"] = "General",
    ["Social & Chat"] = "Social & Chat",
    ["Tooltip & Items"] = "Tooltip & Items",
    ["Unit Frames"] = "Unit Frames",
    ["World & MiniMap"] = "World & MiniMap",
    ["Nameplate Castbar"]="Nameplate Castbar",
["Adds a castbar to the nameplate based on combat log estimations."]="Adds a castbar to the nameplate based on combat log estimations.",
