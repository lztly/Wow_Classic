...
if (GetLocale() == "zhCN") then
  MRBCAT = {
    ...
    ["Advanced Options|cffffff00*"]="高级设置",
    ["Auto Dismount"] = "自动下坐骑",
    ["Automatically dismounts whenever a spell is casted."] = "施法时自动下坐骑。",
    ["Auto Stance"] = "自动站立",
    ["Automatically switch to the required warrior or druid stance on spell cast."] = "在施法时自动切换到所需的战士或德鲁伊姿态。",
    ["Blue Shaman Class Colors"] = "蓝色萨满职业颜色",
    ["Changes the class color code of shamans to blue, as known from TBC+."] = "将萨满的职业颜色更改为蓝色，这在TBC+中是已知的。",
    ["Chat Hyperlinks"] = "聊天超链接",
    ["Copy website URLs from the chat, transforms CLINKs into real items and handles quest and player links."] = "从聊天中复制网站URL，将链接转换为真实项目，并处理任务链接。",
    ["Chat Tweaks"] = "聊天增强",
    ["Allows to scroll using the mouse wheel, enables sticky chat channels and repeats message on arrow up."] = "允许使用鼠标滚轮滚动，启用粘性聊天频道，并向上箭头重复消息。",
    ["Cooldown Numbers"] = "冷却显示",
    ["Display  the remaining duration as text on every cooldown."] = "在每次冷却时以文本形式显示剩余持续时间。",
    ["Custom Settings"] = "自定义设置",
    ["Custom code: Have a look at mods/custom.lua"] = "自定义代码：查看mods/Custom.lua",
    ["Darkened UI"] = "暗黑模式",
    ["Turns the entire interface into darker colors."] = "将整个界面变成深色。",
    ["Equip Compare"] = "装备比较",
    ["Shows currently equipped items on tooltips while the shift key is pressed."] = "按下shift键时，在工具提示上显示当前装备的项目。",
    ["Unit Frame Health Colors"] = "状态数值着色",
    ["Change health text color based on its value."] = "根据运行状况文本的值更改其颜色。",
    ["Real Health Numbers"] = "显示单位生命值",
    ["Estimates health numbers, and shows numbers on player, pet and target unit frames."] = "估计生命值，并显示玩家、宠物和目标单位的生命值和法力值。",
    ["Hide Errors"] = "隐藏lua代码错误",
    ["Hides and ignores all Lua errors produced by broken addons."] = "隐藏并忽略由损坏的插件产生的所有Lua错误。",
    ["Hide Gryphons"] = "隐藏动作条狮鹫",
    ["Hides the gryphons left and right of the action bar."] = "隐藏动作栏左侧和右侧的鹰头狮。",
    ["Item Rarity Borders"] = "物品品质边框染色",
    ["Show item rarity as the border color on bags, bank, character and inspect frames."] = "在袋子、银行、字符和检查框上显示稀有物品的边框颜色。",
    ["MiniMap Clock"] = "小地图时钟",
    ["Adds a small 24h clock to the mini map."] = "在小地图中添加一个24小时小时钟。",
    ["MiniMap Square"] = "方块小地图",
    ["Draw the mini map in a squared shape instead of a round one."] = "把小地图画成正方形而不是圆形。",
    ["MiniMap Tweaks"] = "小地图按钮隐藏",
    ["Hides unnecessary mini map buttons and allows to zoom using the mouse wheel."] = "隐藏不必要的小地图按钮，并允许使用鼠标滚轮进行缩放。",
    ["Movable Unit Frames"] = "头像框体移动",
    ["Player and Target unit frames can be moved while <Shift> and <Ctrl> are pressed together."] = "当同时按下＜Shift＞+＜Ctrl＞时，玩家和目标单位帧可以移动。",
    ["Nameplate Class Colors"] = "姓名板职业颜色",
    ["Changes the nameplate health bar color to the class color."] = "将头像生命值颜色更改为职业颜色。",
    ["Nameplate Scale"] = "姓名板缩放",
    ["Makes all nameplates honor the UI-Scale setting."] = "使所有姓名板都符合UI比例设置。",
    ["Reduced Actionbar Size"] = "简化动作条",
    ["Reduces the actionbar size by removing several items such as the bag panel and microbar"] = "通过移除几个项目（如背包面板和微菜单）来减小操作条的大小",
    ["Sell Junk"] = "自动出售垃圾",
    ["Adds a “Sell Junk” button to every merchant window, that sells all grey items."] = "在每个商家窗口添加一个“出售垃圾”按钮，出售所有灰色物品。",
    ["Social Colors"] = "社交职业颜色",
    ["Show class colors in Who, Guild, Friends and Chat."] = "在查询界面、团队、好友和聊天中显示类颜色。",
    ["Enemy Castbars"] = "目标施法条",
    ["Shows an enemy castbar on target unit frame."] = "在目标单位框架上显示目标施法条。",
    ["Debuff Timer"] = "Debuff计时",
    ["Show debuff durations on the target unit frame."] = "在目标单位框架上显示Debuff计时。",
    ["Tooltip Details"] = "鼠标提示增强",
    ["Display health, class color, guild name, guild rank and current target on unit tooltips."] = "在单位工具提示上显示生命值、职业颜色、工会名称、工会等级和当前目标。",
    ["Hide TWoW Target Health"] = "隐藏目标生命值",
    ["Hide Turtle-WoW Custom Health Points From Target Frame"] = "从目标姓名板隐藏乌龟魔兽世界自定义生命值",
    ["Unit Frame Big Health"] = "头像宽生命条",
    ["Increases the healthbar of the player and target unitframe."] = "增加玩家和目标单位框的生命值条的宽度。",
    ["Unit Frame Class Colors"] = "头像职业颜色",
    ["Adds class colors to the player, target and party unit frames."] = "为玩家、目标和组队单位框架添加职业颜色。",
    ["Unit Frame Class Portraits"] = "头像职业图标",
    ["Replace unitframe portraits with class icons."] = "用职业图标替换单框头像。",
    ["Vendor Values"] = "显示物品商店价",
    ["Shows the vendor sell values on all item tooltips."] = "显示所有物品工具提示上的卖店价格。",
    ["WorldMap Class Colors"] = "世界地图职业颜色",
    ["Show class colored circles on world and battlefield map."] = "在世界和战场地图上显示地区颜色的圆圈。",
    ["WorldMap Coordinates"] = "世界地图坐标",
    ["Adds coordinates to the bottom of the World Map."] = "将坐标添加到世界地图的底部。",
    ["WorldMap Window"] = "世界地图窗口",
    ["Turns the world map into a movable window. The map can be scaled with <Ctrl> + Mousewheel."] = "将世界地图变成一个可移动的窗口。可以使用＜Ctrl＞+鼠标滚轮缩放。",
    ["General"] = "基本设置",
    ["Social & Chat"] = "社交聊天",
    ["Tooltip & Items"] = "物品提示",
    ["Unit Frames"] = "单元框架",
    ...
    ["Adds a castbar to the nameplate based on combat log estimations."]="给姓名板添加施法条",
  }
end
