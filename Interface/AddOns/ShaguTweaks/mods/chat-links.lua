...
local module = ShaguTweaks:register({
  title = MRBCAT["Chat Hyperlinks"],
  description = MRBCAT["Copy website URLs from the chat, transforms CLINKs into real items and handles quest and player links."],
  expansions = { ["vanilla"] = true, ["tbc"] = true },
  category = MRBCAT["Social & Chat"],
  enabled = true,
})
