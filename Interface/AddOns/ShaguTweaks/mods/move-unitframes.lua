...
local module = ShaguTweaks:register({
  title = MRBCAT["Movable Unit Frames"],
  description = MRBCAT["Player and Target unit frames can be moved while <Shift> and <Ctrl> are pressed together."],
  expansions = { ["vanilla"] = true, ["tbc"] = true },
  category = MRBCAT["Unit Frames"],
  enabled = nil,
})
