...
local module = ShaguTweaks:register({
  title = MRBCAT["Tooltip Details"],
  description = MRBCAT["Display health, class color, guild name, guild rank and current target on unit tooltips."],
  expansions = { ["vanilla"] = true, ["tbc"] = true },
  category = MRBCAT["Tooltip & Items"],
  enabled = nil,
})
...
local function UpdateTooltip()
  ...
  local pvptitle = gsub(pvpname or name, MRBCAT[" "]..name, MRBCAT[""], 1)
