...
local module = ShaguTweaks:register({
  title = MRBCAT["WorldMap Window"],
  description = MRBCAT["Turns the world map into a movable window. The map can be scaled with <Ctrl> + Mousewheel."],
  expansions = { ["vanilla"] = true, ["tbc"] = true },
  category = MRBCAT["World & MiniMap"],
  enabled = true,
})
